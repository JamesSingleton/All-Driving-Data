...
import static com.example.jamessingleton.chffrapi.R.id.responseView;

/**
 * Created by James Singleton on 8/22/2016.
 */

public class APIRequests extends Activity {
    ...
    AuthPreferences authPreferences = new AuthPreferences(mActivity);
